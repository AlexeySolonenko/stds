...
<section id="header" >
    <div id="page" class="site">
                        ...
                        <nav class="navbar  navbar-expand-xl p-0">
                            <div class="navbar-brand"><?php 
                                if ( get_theme_mod( 'wp_bootstrap_starter_logo' ) ): ?>
                                    ...
                                    ?><a class="site-title" href="<?php echo esc_url( home_url( '/' )); ?>"><?php esc_url(bloginfo('name')); ?></a><?php
                                endif; 
                            ?></div>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-nav" aria-controls="" aria-expanded="false" aria-label="Toggle navigation">
                                <span class="navbar-toggler-icon"></span>
                            </button><?php
                            wp_nav_menu($wpNavMenuConfig);
                        ?></nav>
                    </div>
                </header><!-- #masthead --><?php
                /* end of header, start title and scroller  */
       ...
       <!-- <div id="content" class="site-content"> -->
            ...
            <?php endif; /* if template is not for a blank page */?>
</section>